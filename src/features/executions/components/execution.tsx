...
export const ExecutionView = ({ executionId }: Props) => {
      ...
      <CardContent className="space-y-4">
          ...
          <div className="mt-6 p-4 bg-red-50 rounded-md space-y-3">
            ...
            {execution.errorStack && (
              ...
              >
                ...
                <CollapsibleContent>
                  <pre className="text-xs text-red-800 overflow-auto font-mono mt-2 p-2 bg-red-100 rounded-md">
                    {execution.errorStack}
                  </pre>
                </CollapsibleContent>
              </Collapsible>
        ...
        {execution.output && (
          <div className="mt-6 p-4 bg-muted rounded-md">
            ...
            <pre className="text-sx font-mono overflow-auto">
