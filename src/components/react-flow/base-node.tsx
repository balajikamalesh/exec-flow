...
// collection of reusable React components for building custom nodes in a React Flow diagram editor.
export function BaseNode({ className, status, ...props }: BaseNodeProps) {
  return (
    <div
      className={cn(
        "bg-card text-card-foreground relative rounded-md border border-muted-foreground hover:bg-muted",
        "hover:ring-1 ",
        className,
      )}
      tabIndex={0}
